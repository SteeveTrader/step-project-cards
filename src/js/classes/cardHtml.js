 export default class CardHtml {
    constructor(purpose, description, urgency, fullname, doctor) {
        ...
        this.doctor = doctor;
        this.container = document.querySelector(".reserwation__card-container");
...
//  <div class="reserwation__card-doctor">
//                         <h2>${this.doctor}</h2>

//                         <div class="reserwation__btn-container">
//                             <button class="reserwation__edit-btn">
...
//                             <button class="reserwation__delete-btn">
...
//                     <p class="reserwation__card-patient-name">${this.fullname}</p>

//                     <button class="reserwation-show-info-btn">Show more</button>
